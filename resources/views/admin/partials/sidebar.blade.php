    ...
    <div class="h-full flex flex-col">
        ...
        <div class="px-6 py-5 flex items-center gap-3">
            <img src="{{ asset($adminPic) }}"
                 alt="Admin Avatar"
                 class="h-11 w-11 rounded-full object-cover border border-black/10" />

            <div class="leading-tight flex-1">
                <div class="text-sm font-semibold text-gray-900">{{ $adminName }}</div>
                <div class="text-xs text-gray-500">{{ $adminUsername }}</div>
                <div class="text-xs text-gray-400">{{ $adminRole }}</div>
            </div>
