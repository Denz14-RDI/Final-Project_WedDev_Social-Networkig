{{-- Welcome View
Landing page that introduces PUPCOM, highlights core features, and directs users to sign in. --}}
...
>
  {{-- Background gradient and overlay (matches login/register theme) --}}
  ...
  <div class="relative z-10 w-full max-w-6xl text-center">
    ...
    {{-- HERO GLASS WRAPPER (improves text readability over background) --}}
